...
| Cryptoassets received as income or bought personally | [Cryptoasset receipt guidance snapshot](guidance/public-guidance/cryptoassets-received/content.html) | [Check if you need to pay tax when you receive cryptoassets](https://www.gov.uk/guidance/check-if-you-need-to-pay-tax-when-you-receive-cryptoassets) | Distinguish a personal purchase from tokens received through employment or other income-producing activity; retrieved 19 September 2026 |
